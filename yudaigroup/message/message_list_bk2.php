...
$sql = "select a.message_id,a.employee_id,a.title,a.content,a.attachment,a.attachmentname,to_char(a.add_date,'YYYY/MM/DD HH24:MI'),b.status from message as a LEFT OUTER JOIN message_log as b ON a.message_id = b.message_id and b.employee_id = $ybase->my_employee_id and b.status <> '0' where a.status = '1'".$add_sql." order by a.add_date desc";
