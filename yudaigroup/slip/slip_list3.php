...
foreach($q_attach_arr as $key => $val){
	...
	if($ext == 'pdf'){
		...
		$d_attach .= "<iframe width=\"300\" height=\"300\" src=\"../inc/pdfjs/web/viewer3.html?file=$pdffile\"></iframe><br><a href=\"./view.php?slip_id=$q_slip_id&attach_no=$key\" target=\"_blank\" type=\"button\" class=\"btn btn-secondary btn-sm\">拡大</a>　<a href=\"dl.php?slip_id=$q_slip_id&attach_no=$key\" type=\"button\" class=\"btn btn-secondary btn-sm\">ダウンロード</a><br>";
	}else{
		$d_attach .= "<iframe width=\"300\" height=\"300\" src=\"./slip_iframe.php?slip_id=$q_slip_id&attach_no=$key&ext=$ext\"></iframe><br><a href=\"./view.php?slip_id=$q_slip_id&attach_no=$key\" target=\"_blank\" type=\"button\" class=\"btn btn-secondary btn-sm\">拡大</a>　<a href=\"dl.php?slip_id=$q_slip_id&attach_no=$key\" type=\"button\" class=\"btn btn-secondary btn-sm\">ダウンロード</a><br>";
	}
}
	...
	list($dl_log_id,$dl_add_date) = pg_fetch_array($result3,$iii);
		$dl_list .= "<small class=\"text-center\">$dl_add_date DL</small>\n";
	}
