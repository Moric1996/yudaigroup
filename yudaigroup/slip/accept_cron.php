...
$sql = "select to_employee_id,count(*),array_to_json(array_agg(slip_id)) from accept_log where send_flg = '0' and status = '1' group by to_employee_id order by to_employee_id";
