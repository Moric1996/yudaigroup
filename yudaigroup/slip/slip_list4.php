...
$param = "sel_status=$sel_status&sel_slip_type=$sel_slip_type&sel_action_date_st=$sel_action_date_st&sel_action_date_ed=$sel_action_date_ed&sel_month_st=$sel_month_st&sel_month_ed=$sel_month_ed&sel_section_id=$sel_section_id&sel_charge_emp=$sel_charge_emp&sel_supplier=$sel_supplier&sel_account=$sel_account&sel_money=$sel_money".$accept_param;
//////////////////////////////////////////
...
////////////////////
	if($ext == 'pdf'){
		...
		$d_attach .= "<iframe width=\"300\" height=\"300\" src=\"./slip_iframe.php?slip_id=$q_slip_id&attach_no=$key&ext=$ext\"></iframe><br>DL<input type=\"checkbox\" name=\"downloadck{$slipatno}\" value=\"1\" id=\"downloadck{$slipatno}\" slipatno=\"{$slipatno}\" class=\"mr-5\" style=\"transform: scale(1.5)\"><a href=\"./view.php?slip_id=$q_slip_id&attach_no=$key\" target=\"_blank\" type=\"button\" class=\"btn btn-secondary btn-sm\">拡大</a>　<a href=\"./dl.php?slip_id=$q_slip_id&attach_no=$key\" type=\"button\" class=\"btn btn-secondary btn-sm\" id=\"dl{$slipatno}\">ダウンロード</a><br>";
	}
}
