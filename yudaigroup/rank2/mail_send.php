...
if($maillistbcc){
	$addheadbcc = "Bcc: $frommail,$maillistbcc\n";
	$addsqlbcc = "{"."$maillistbcc"."}";
}else{
	$addheadbcc = "Bcc: $frommail\n";
	$addsqlbcc = "{}";
}


$fileurl = "https://yournet-jp.com/yudaigroup/rank/daily_achieve2.php?t_month=$t_month&t_shop_id=$t_shop_id";
...
$sql = "insert into telecom2_mail_log  (mail_id,shop_id,employee_id,to_ls,cc_ls,bcc_ls,from1,title,message,add_date,status) values (nextval('telecom2_mail_log_id_seq'),$t_shop_id,$ybase->my_employee_id,'$addsqlto','$addsqlcc','$addsqlbcc','$frommail','$title','$mailbody','now','1')";
