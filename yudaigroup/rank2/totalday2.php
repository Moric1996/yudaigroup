...
//当日目標
$sql = "select item_id,dgoal_num from telecom2_goal_day where {$addsql} and day = $target_day order by item_id";
$result3 = $ybase->sql($conn,$sql);
$num3 = pg_num_rows($result3);
for($i=0;$i<$num3;$i++){
...
//当日実績個人
$sql = "select item_id,employee_id,action_num from telecom2_action where {$addsql} and day = $target_day order by item_id,employee_id";
$result3 = $ybase->sql($conn,$sql);
$num3 = pg_num_rows($result3);
for($i=0;$i<$num3;$i++){
