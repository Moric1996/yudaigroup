...
$all_total=0;
$sql = "select item_id,day,action_num from telecom2_action where {$addsql} and employee_id = $target_employee_id order by item_id,day";
$result3 = $ybase->sql($conn,$sql);
$num3 = pg_num_rows($result3);
for($i=0;$i<$num3;$i++){
