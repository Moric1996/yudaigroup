...
$sql = "insert into telecom2_comment (comment_id,shop_id,employee_id,comment,add_date,status) values ($new_comment_id,$sec_id,$ybase->my_employee_id,'$comment','now','1')";
$result = $ybase->sql($conn,$sql);
