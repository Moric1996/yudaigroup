...
$sql = "select nextval('telecom2_group_id_seq')";
...
$sql = "insert into telecom2_group (group_id,group_name,shop_id,month,add_date,status) values ($new_group_id,'',$target_shop_id,$target_month,'now','1')";
$result = $ybase->sql($conn,$sql);

//////項目も追加
$sql = "insert into telecom2_group_const (group_const_id,shop_id,month,group_id,add_date,status) values (nextval('telecom2_group_const_id_seq'),$target_shop_id,$target_month,$new_group_id,'now','1')";
$result = $ybase->sql($conn,$sql);
