...
/////////////////////////
//////項目も追加
$sql = "insert into telecom_group_const (group_const_id,shop_id,month,group_id,add_date,status) values (nextval('telecom_group_const_id_seq'),$target_shop_id,$target_month,$t_group_id,'now','1')";
