...
<form action="./person_in_sp.php" method="post" id="Form1">
...
<tr><td>
<form action="person_in_sp.php" method="get" id="dayselectfrom">
<input type="hidden" name="t_month" value="$t_month">
<input type="hidden" name="t_shop_id" value="$t_shop_id">
...
<td>
<nobr>
<a href="person_in_sp.php?$param&target_day=$bf&target_employee_id=$target_employee_id" class="btn btn-sm btn-outline-secondary{$bf_disable}">前日</a>
<a href="person_in_sp.php?$param&target_day=$nx&target_employee_id=$target_employee_id" class="btn btn-sm btn-outline-secondary{$nx_disable}">翌日</a>
</nobr>
</td><td align="right">
