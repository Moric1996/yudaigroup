...
/////////////////////////
$sql = "select order_num from telecom_item where {$addsql} and bigitem_id = $t_bigitem_id and status = '1' order by order_num desc";
...
$sql = "insert into telecom_item (item_id,item_name,shop_id,month,bigitem_id,score,order_num,add_date,status) values (nextval('telecom_item_id_seq'),'',$target_shop_id,$target_month,$t_bigitem_id,0,$next_order_num,'now','1')";
$result = $ybase->sql($conn,$sql);
