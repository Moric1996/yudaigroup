...
$(function(){
	$("[id^=plus]").click(function(){
		...
		if((itemid == 145)||(itemid == 146)||(itemid == 147)||(itemid == 148)||(itemid == 149)||(itemid == 150)||(itemid == 152)){
		...
		if((itemid == 145)||(itemid == 146)||(itemid == 147)){
...
<form action="./person_in1.php" method="post" id="Form1">
...
<tr><td>
<nobr><b>{$MONTH}月 {$target_day}日({$youbi})</b></nobr>
</td>
<td>
<nobr>
<a href="person_in1.php?$param&target_day=$bf&target_employee_id=$target_employee_id" class="btn btn-sm btn-outline-secondary{$bf_disable}">前日</a>
<a href="person_in1.php?$param&target_day=$nx&target_employee_id=$target_employee_id" class="btn btn-sm btn-outline-secondary{$nx_disable}">翌日</a>
</nobr>
</td><td align="right">
