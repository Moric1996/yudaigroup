...
$cc_arr = array();
$bcc_arr = array();
$sql = "select mail_id,employee_id,array_to_json(to_ls),array_to_json(cc_ls),array_to_json(bcc_ls),from1,title,message,to_char(add_date,'YYYY/MM/DD HH24:MI') from telecom_mail_log where {$addsql} order by add_date desc";
...
<br>
<div style="text-align:center;"><a href="{$pdffilename}?$param" target="_blank" class="btn btn-sm btn-outline-info">添付ファイル確認</a>
</div><br>
