...
<div class="card border border-dark mx-auto">
<div class="card-header border-dark alert-info text-center">jinjerファイルからアップロード</div>
<div class="card-body">
<form action="./jinjer_up.php" method="post" enctype="multipart/form-data" id="form2">
