...
<div class="col-xs-10">
    ...
    <div class="form-row">
        ...
        <form method="get" action="./csv_display.php" class="form-inline">
            ...
            <a href="./csv_year_display.php?shop_id=<?= $shop_id ?>&target_date=<?= $target_date ?>"
    ...
    <table border="1">
        ...
        <? foreach ((array)$display_array as $one_code => $name): ?>
            ...
            if (in_array($one_code, array(10006, 10007, 10008))) {
                $tr_color = 'style="background-color:#efbdca;"';
            }
            ?>
            <tr <?= $tr_color ?>>
