...
// 各種変数の初期化
$accountid_err = ""; // 未定義エラー修正
$passwd = isset($_COOKIE['setpasswd']) ? $_COOKIE['setpasswd'] : ""; // パスワードの初期化
...
if(isset($_GET)){
	foreach($_GET as $key => $value){
		$addhtml .= "<input type=\"hidden\" name=\"$key\" value=\"$value\">\n";
	}
}
...
<div class="card-body">
<form action="login_ex.php" method="post" id="LoginForm">
$addhtml
