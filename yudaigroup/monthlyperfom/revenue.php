...
<div class="content-wrapper" style="margin-left: 0 !important;">
    ...
    <section class="content-header">
        ...
        <div class="form-row">
            <div class="col-xs-10">
                <form method="get" action="./revenue.php" class="form-inline">
...
<script type="text/javascript">
    ...
    for(var key in chartData){
        ...
        for(var month in chartData[key]){
            ...
            //売上
            monthlyDataArr["売上"].push(chartData[key][month]["売上"][0]);
            //売上予算
            monthlyDataArr["売上予算"].push(chartData[key][month]["売上"][1]);
            //売上前年
            monthlyDataArr["売上前年"].push(chartData[key][month]["売上"][2]);
