...
<div class="content-wrapper" style="margin-left: 0 !important;">
    ...
    <section class="content-header">
        ...
        <div class="form-row">
            <div class="col-xs-10">
                <form method="get" action="./worktime.php" class="form-inline">
...
<script type="text/javascript">
    ...
    for(var key in chartData){
        ...
        // monthlyDataArr["売上前年"] = [];
        monthlyDataArr["労働時間"] = [];
        monthlyDataArr["労働時間予算"] = [];
        monthlyDataArr["労働時間前年"] = [];
        // monthlyDataArr["労働時間"] = [];
        // monthlyDataArr["人時売上"] = [];
        ...
        for(var month in chartData[key]){
            ...
            //労働時間予算
            monthlyDataArr["労働時間予算"].push(chartData[key][month]["労働時間"][1]);
            //労働時間前年
            monthlyDataArr["労働時間前年"].push(chartData[key][month]["労働時間"][2]);
