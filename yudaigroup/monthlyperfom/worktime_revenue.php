...
<div class="content-wrapper" style="margin-left: 0 !important;">
    ...
    <section class="content-header">
        ...
        <div class="form-row">
            <div class="col-xs-10">
                <form method="get" action="./worktime_revenue.php" class="form-inline">
...
<script type="text/javascript">
    ...
    for(var key in chartData){
        ...
        // monthlyDataArr["売上前年"] = [];
        monthlyDataArr["人時売上"] = [];
        monthlyDataArr["人時売上予算"] = [];
        monthlyDataArr["人時売上前年"] = [];
        // monthlyDataArr["労働時間"] = [];
        // monthlyDataArr["人時売上"] = [];
        ...
        for(var month in chartData[key]){
            ...
            //人時売上予算
            monthlyDataArr["人時売上予算"].push(chartData[key][month]["人時売上"][1]);
            //人時売上前年
            monthlyDataArr["人時売上前年"].push(chartData[key][month]["人時売上"][2]);
