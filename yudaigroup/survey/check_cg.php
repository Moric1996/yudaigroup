...
if(!preg_match("/^[0-9]+$/",$check_flag)){
	$ybase->error("パラメーターエラー。ERROR_CODE:11214");
}
...
//アンケートの存在確認
$sql = "update survey_answer set confirm = '$check_flag',confirm_date='now',confirm_staff='{$ybase->my_employee_id}' where answer_id = $t_answer_id and survey_set_id = $survey_set_id";
