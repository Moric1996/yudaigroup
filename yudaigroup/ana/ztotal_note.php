...
<form action="ztotal_note.php" method="post" id="form1">
...
$sql = "select to_char(sale_date,'FMDD'),pos_ztotal_note_id,ztotal_no,note_item_name,note_price,note_count,note_sheet from pos_ztotal_note where pos_shopno = $pos_shopno and sale_date between '$s_yymm' and '$e_yymm' and status = '1' and note_price <> 0 order by sale_date,ztotal_no";
