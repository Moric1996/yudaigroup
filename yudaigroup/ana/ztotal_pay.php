...
$ybase->title = "店舗集計-支払いメディア(その他掛)集計";
...
<form action="ztotal_pay.php" method="post" id="form1">
...
$sql = "select to_char(sale_date,'FMDD'),pos_ztotal_pay_id,ztotal_no,pay_item_name,pay_price,pay_count,pay_sheet from pos_ztotal_pay where pos_shopno = $pos_shopno and sale_date between '$s_yymm' and '$e_yymm' and status = '1' and pay_price <> 0 and ztotal_no between 113 and 131 and ztotal_no <> 116 order by sale_date,ztotal_no";
