...
$tcpdf->SetMargins(10, 3, 10);
$tcpdf->SetAutoPageBreak(true,3);
$tcpdf->setPrintHeader(false);
$tcpdf->setPrintFooter(false);
$tcpdf->SetFont("kozminproregular", "", 9.1);
...
<h3 class="text-center">{$taget_shop_name}シフト表【{$taget_YY}年{$taget_MM}月{$dkey}日】</h3>
<table border="1" align="center" style="font-size:107%;" cellpadding="1" width="1120">
<tr align="center">
<th rowspan="2">
時間
</th>
...
<span style="text-align:right;">$tval</span>
</td>
</tr>
HTML;
