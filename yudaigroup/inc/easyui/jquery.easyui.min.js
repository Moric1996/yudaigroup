...
cc.push("<span class=\"tree-indent\"></span>");
if((item.ext=="mp4")||(item.ext=="mpeg")||(item.ext=="mpg")||(item.ext=="avi")||(item.ext=="webm")||(item.ext=="mov")){
cc.push("<span class=\"tree-icon tree-file2 "+(item.iconCls?item.iconCls:"")+"\"></span>");
}else{
if((item.ext=="doc")||(item.ext=="docx")||(item.ext=="xls")||(item.ext=="xlsx")||(item.ext=="ppt")||(item.ext=="pptx")){
cc.push("<span class=\"tree-icon tree-file3 "+(item.iconCls?item.iconCls:"")+"\"></span>");
}else{
...
cc.push("<span class=\"tree-indent\"></span>");
if((row.ext=="mp4")||(row.ext=="mpeg")||(row.ext=="mpg")||(row.ext=="avi")||(row.ext=="webm")||(row.ext=="mov")){
cc.push("<span class=\"tree-icon tree-file2 "+(row.iconCls?row.iconCls:"")+"\"></span>");
}else{
if((row.ext=="doc")||(row.ext=="docx")||(row.ext=="xls")||(row.ext=="xlsx")||(row.ext=="ppt")||(row.ext=="pptx")){
cc.push("<span class=\"tree-icon tree-file3 "+(row.iconCls?row.iconCls:"")+"\"></span>");
}else{
